export const PROJECTS = [
    {
        post_image: {
            image_title: 'TranslatinOtaku',
            image_url:
                'https://res.cloudinary.com/mosiur404/image/upload/c_thumb,w_600,h_400,g_face/v1681839138/blog/projects/translatinotaku-1_lyamuu.png'
        },
        post_title: 'TranslatinOtaku',
        post_slug: 'translatinotaku',
        excerpt: `
        <ul>
            <li>Website: <a href="https://translatinotaku.net">https://translatinotaku.net</a></li>
            <li>Tech: Bootstrap 5, JS, Custom WP Plugin</li>
        </ul>`,
        post_content: `
        <div class="row">
            <div class="col-4">
    ...
    {
        post_image: {
            image_title: 'Strat-O-S',
            image_url: `https://res.cloudinary.com/mosiur404/image/upload/c_thumb,w_600,h_400,g_face/v1681839137/blog/projects/strat-o-s_jjkf59.png`
        },
        post_title: 'Strat-O-S',
        post_slug: 'strat-o-s',
        excerpt: `
        <ul>
            <li>Website: <a href="https://strat-o-s.com">https://strat-o-s.com</a></li>
            <li>Tech: JS, Custom WP Extension</li>
        </ul>`,
        post_content: `
        <div class="row">
        <div class="col-4">
...
export const SIDE_PROJECTS = [
    {
        post_image: {
            image_title: 'MERN Todo App',
            image_url:
                'https://res.cloudinary.com/mosiur404/image/upload/v1681948735/blog/projects/todo-1_qnnb4o.png'
        },
        post_title: 'Todo App',
        post_slug: 'mern-todo-app',
        excerpt: `
                <ul>
